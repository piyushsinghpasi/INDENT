...
def pad_collate(batch):
    ...
    batch_chunks = torch.from_numpy(torch.stack(collapsed_segs).detach().cpu().numpy())
...
class CARE_dataset(Dataset):
    ...
    def __init__(self, segs_dir, nsample, vad_text_feat_dir, qns_emb_file = './../care_india/questions/questions_00-02_hindi_labse_embeddings.json', train=None, transform = None):
...
class Question_dataset_Fixed(Dataset):
    def __init__(self, test_data_object, file_name, csv_dir='../care_india_data/audio_hindi_val_csv/', test_file='./../care_india/audio_features_dict_valdata_5ques.json', qns_file = './../care_india/questions/questions_00-02_hindi.json', qns_emb_file = './../care_india/questions/questions_00-02_hindi_labse_embeddings.json', transform=None):
        self.transform = transform
