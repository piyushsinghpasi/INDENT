'''
This file contains code for training and evaluating for model with learnt attention instead of gaussian weighted cross attention in the model 
...
from net.net_e2e_indicspeech_learnt_text_learnt_attn import Feat_Merger
