...
from dataloader_trans_miou import *
...
from utils.recall_eval_miou import eval
...
def main():
    ...
    if args.mode == 'train':
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            tot_R_1, tot_R_5, tot_R_10, tot_R_avg, tot_mIoU = 0., 0., 0., 0., 0.
            for file_name in train_files:
                ...
                #     curr_device=DEVICE,
                # )
                tot_R_1, tot_R_5, tot_R_10, tot_R_avg, tot_mIoU = tot_R_1+a, tot_R_5 +b, tot_R_10+c, tot_R_avg+d, tot_mIoU+e

            train_metrics = "{:.3f}\t{:.3f}\t{:.3f}\t{:.3f}\t{:.3f}\n".format( tot_R_1/len(train_files), tot_R_5/len(train_files), tot_R_10/len(train_files), tot_R_avg/len(train_files), tot_mIoU/len(train_files))
