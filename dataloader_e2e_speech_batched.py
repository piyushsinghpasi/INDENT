...
class CARE_dataset(Dataset):
    ...
    def __init__(self, segs_dir, nsample, vad_chunks_feat_dir, qns_emb_file = './../care_india/questions/questions_00-02_hindi_labse_embeddings.json', train=None, transform = None):
