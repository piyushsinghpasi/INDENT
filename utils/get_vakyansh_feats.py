...
asr_model.encoder.layers[layer_no].final_layer_norm.register_forward_hook(get_activation(layer_name))
...
if __name__ == "__main__":
	...
	vad_wav = "vad_chunks"
	vad_chunks_feat = "vad_chunks_feat_vakyansh_layer{}_final_norm".format(layer_no)
