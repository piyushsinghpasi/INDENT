...
class Feat_Merger(nn.Module):
    ...
    def __init__(self, input_dim = 768, hidden_dim = 768, dropout = 0.3, kernel_size = 20, stride = 2, std = 0.5):
    ...
    def forward(self, speech, text, speech_padding_mask, segment_len, chunk_timestep_len, max_pad, speech_attn_mask = None, padding_cross_attn_mask = None):
        ...
        s_feat = agg_speech + self.speech_dropout(self.fc_speech(agg_speech))
        s_feat = self.speech_norm(s_feat)
